$(document).ready(function() {
    ...
    $('.carousel2').slick({
        ...
        dots: false,
        adaptiveHeight: true,
        prevArrow: '<button type="button" class="slick-prev"><img src="../img/left_blue.png"></button>',
        nextArrow: '<button type="button" class="slick-next"><img src="../img/right_blue.png"></button>',
        responsive: [{
            breakpoint: 992,
            settings: {
                dots: true,
